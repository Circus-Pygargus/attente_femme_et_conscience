...
class RendezVous
{
    ...
    public function getDateAndSchedule(): ?string
    {
        return $this->dateAndSchedule;
    }

    public function setDateAndSchedule(?string $dateAndSchedule): self
    {
        $this->dateAndSchedule = $dateAndSchedule;
